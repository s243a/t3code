...
export interface AcpSessionRuntimeOptions {
  ...
  /**
   * Auth method to present at startup. Omit for agents that expose no auth
   * step — the `authenticate` request is then skipped rather than sent with a
   * method the agent never advertised.
   */
